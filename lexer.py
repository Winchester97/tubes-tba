class Lexer(object):
    ...
    def tokenisasi(self):
        ...
        state_n = lambda string : state_no(string[1:]) if (string[0]=='o') else state_error()
        state_no = lambda string : state_not(string[1:]) if (string[0]=='t') else state_error()
        state_not = lambda string : state_error() if (bool(string)) else 2
        state_a = lambda string : state_an(string[1:]) if (string[0]=='n') else state_error()
        state_an = lambda string : state_and(string[1:]) if (string[0]=='d') else state_error()
        state_and = lambda string : state_error() if (bool(string)) else 3
        state_o = lambda string : state_or(string[1:]) if (string[0]=='r') else state_error()
        state_or = lambda string : state_error() if (bool(string)) else 4
        state_x = lambda string : state_xo(string[1:]) if (string[0]=='o') else state_error()
        state_xo = lambda string : state_xor(string[1:]) if (string[0]=='r') else state_error()
        state_xor = lambda string : state_error() if (bool(string)) else 5
        state_i = lambda string : state_if(string[1:]) if (string[0]=='f') else state_error()
        state_if = lambda string : cek_iff(string) if (bool(string)) else 6
        cek_iff = lambda string : state_iff(string[1:]) if (string[0]=='f') else state_error()
        state_iff = lambda string : state_error() if (bool(string)) else 8
        state_t = lambda string : state_th(string[1:]) if (string[0]=='h') else state_error()
        state_th = lambda string : state_the(string[1:]) if (string[0]=='e') else state_error()
        state_the = lambda string : state_then(string[1:]) if (string[0]=='n') else state_error()
